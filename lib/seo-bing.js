...
/**
 * ✅ PHASE 1: Generate NewsArticle Schema for News Content
 * Optimized for Google News and Bing News
 * @param {Object} post - Blog post object
 * @returns {Object} NewsArticle structured data
 */
export function generateNewsArticleSchema(post) {
    ...
    const schema = {
        '@context': 'https://schema.org',
        '@type': 'NewsArticle', // ✅ KEY DIFFERENCE: NewsArticle instead of Article
        '@id': postUrl,
        headline: post.title,
        description: post.excerpt || post.seoDescription,

        // ✅ News-specific: Dateline (location + date)
        dateline: post.location || 'India',
        ...
        // ✅ News expires after 7 days for trending/breaking news
        expires: post.publishedAt ? new Date(new Date(post.publishedAt).getTime() + 7 * 24 * 60 * 60 * 1000).toISOString() : undefined,
        ...
        // ✅ News-specific: Article section for categorization
