...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50/50 via-white to-gray-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-96 h-96 bg-gradient-to-br from-slate-500/10 to-gray-500/10 dark:from-slate-500/5 dark:to-gray-500/5 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-20 left-10 w-80 h-80 bg-gradient-to-tr from-gray-500/10 to-slate-500/10 dark:from-gray-500/5 dark:to-slate-500/5 rounded-full blur-3xl pointer-events-none"></div>
