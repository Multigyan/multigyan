  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50/50 to-white">
      ...
      <main id="main-content" role="main">
        ...
        <article className="py-12" itemScope itemType="https://schema.org/Recipe">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <header className="mb-8">
                {/* ✅ SEMANTIC FIX: Add itemProp for recipe name */}
                <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 bg-gradient-to-r from-green-700 to-emerald-700 bg-clip-text text-transparent" itemProp="name">
                  {post.title}
                </h1>

                {/* ✅ SEMANTIC FIX: Add itemProp for recipe description */}
                {post.excerpt && (
                  <p className="text-xl text-gray-700 leading-relaxed mb-6 border-l-4 border-green-600 pl-4 bg-green-50/50 py-3" itemProp="description">
                    {post.excerpt}
                  </p>
                )}
              ...
              {/* Featured Image */}
              {/* ✅ SEMANTIC FIX: Add itemProp for recipe image */}
              {post.featuredImageUrl && (
                <div className="mb-8 rounded-xl overflow-hidden shadow-2xl ring-4 ring-green-100" itemProp="image" itemScope itemType="https://schema.org/ImageObject">
                  <img
              ...
              {/* Recipe Content */}
              {/* ✅ SEMANTIC FIX: Add itemProp="recipeInstructions" for content extractors */}
              <div className="blog-content mb-12 p-6 bg-white rounded-xl shadow-sm border border-green-100" itemProp="recipeInstructions">
                <div
