...
import { AlertCircle, Home, RefreshCw, Wrench } from 'lucide-react'

export default function DIYError({
    error,
    reset,
}) {
    useEffect(() => {
        console.error('DIY Page Error:', error)
    }, [error])

    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-orange-50/30 dark:from-gray-900 dark:to-gray-800 p-4">
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="relative">
                                <Wrench className="h-20 w-20 text-orange-500 animate-pulse" />
