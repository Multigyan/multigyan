...
export default function NewsletterPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50/50 via-white to-pink-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden">
      {/* Decorative Background Elements */}
      <div className="absolute top-20 right-10 w-96 h-96 bg-gradient-to-br from-purple-500/10 to-pink-500/10 dark:from-purple-500/5 dark:to-pink-500/5 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-20 left-10 w-80 h-80 bg-gradient-to-tr from-pink-500/10 to-purple-500/10 dark:from-pink-500/5 dark:to-purple-500/5 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="relative z-10 py-16">
        ...
        <div className="container mx-auto px-4 mb-16">
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-white/20 dark:border-gray-700/20 rounded-xl p-8 shadow-xl">
              <NewsletterSubscribe
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center bg-gradient-to-br from-primary to-purple-500 dark:from-purple-900/40 dark:to-pink-900/40 rounded-xl p-8 md:p-12 text-white">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Join Our Community?
            </h2>
            <p className="text-lg mb-8 opacity-90 dark:text-purple-100">
              Subscribe now and get access to exclusive content, weekly digests, and be part of a growing community of learners.
            </p>
            <a
              href="#top"
              className="inline-block bg-white text-primary dark:bg-purple-100 dark:text-purple-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 dark:hover:bg-purple-200 transition"
            >
              Subscribe Now
            </a>
          </div>
